...
void fe_getforce(VectorXd& f_tot, int ndof, VectorXd& u, VectorXd& fext, int time_step_counter, VectorXd& u_prev, double dT, VectorXd& f_damp, VectorXd& d, VectorXd& d_fatigue, VectorXd& d_tot, VectorXd& lambda_min, VectorXd& lambda_max, VectorXd& d_avg, int& n_load_cycle_full, int& n_load_cycle_partial, double t);
...
void fe_damageVariableWrite_new(std::string& damage_variables, int plot_state_counter, double& t, double& d_curr, double& d_fatigue_curr, double& d_tot);

void fe_damageVariableWrite_append(std::string& damage_variables, int plot_state_counter, double& t, double& d_curr, double& d_fatigue_curr, double& d_tot);

void fe_damageVariableExport(std::string& damage_variables_export, VectorXd& d, VectorXd& d_fatigue, VectorXd& d_tot);

void fe_damageVariableImport(std::string& damage_variables_import, VectorXd& d, VectorXd& d_fatigue, VectorXd& d_tot);
