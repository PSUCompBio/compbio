...
extern double *dndr_store, *dnds_store, *dndt_store, **x_store, **y_store, **z_store, x_normal, y_normal, z_normal, *wtx_normal, **wty_normal, ***wtz_normal, f_ext_e_sum_normal, ******jacobian_store, ******invJacobian_store, ****det_store, *****dndx_store, *****dndy_store, *****dndz_store, ******invDistGrad_prev, ******devInstantPk1Stress_prev, ******devInternalPk1Stress1_prev, ******devInternalPk1Stress2_prev;
...
extern MatrixXd disp_mat_normal, defGrad_normal;
=======
...
extern MatrixXd disp_mat_normal, *nodes_host_normal, *nodes_embed_normal;
